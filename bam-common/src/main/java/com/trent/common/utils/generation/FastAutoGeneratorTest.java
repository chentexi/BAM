...
//import com.trent.common.utils.generation.H2CodeGeneratorTest;
...
//		InputStream inputStream = H2CodeGeneratorTest.class.getResourceAsStream("../bam.sql");
...
//				// 包配置
//				.packageConfig((scanner, builder) -> builder.parent(scanner.apply("")))
//				// 策略配置
